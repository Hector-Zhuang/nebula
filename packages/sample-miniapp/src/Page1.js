    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.buttonWrap}>
          <Button 
            ...
            onPress={() => run('navigateTo', () => 
              MiniAppAPI.navigateTo(`nebula://sample-miniapp/page2?from=page1&ts=${Date.now()}`)
            )}
            color="#3b82f6"
          />
        </View>
        <View style={styles.buttonWrap}>
          <Button 
            ...
            onPress={() => run('navigateTo', () => 
              MiniAppAPI.navigateTo(`nebula://sample-miniapp/page3?from=page1&ts=${Date.now()}`)
            )}
            color="#8b5cf6"
          />
        </View>
        <View style={styles.buttonWrap}>
          <Button 
            ...
            onPress={() => run('redirectTo', () => 
              MiniAppAPI.redirectTo(`nebula://sample-miniapp/page2?replaced=true`)
            )}
            color="#f59e0b"
          />
        </View>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.buttonWrap}>
          <Button 
            title="wx.showToast" 
            onPress={() => run('showToast', () => wx.showToast({ title: 'Page 1 says hi!' }))}
            color="#06b6d4"
          />
        </View>
      </View>
