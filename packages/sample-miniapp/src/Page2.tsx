      ...
      <View style={styles.card}>
        ...
        <View style={styles.buttonWrap}>
          <Button
            ...
            onPress={() =>
              run('navigateTo', () =>
                Miniapp.navigateTo(`/page1?from=page2&ts=${Date.now()}`),
              )
            }
            color="#3b82f6"
          />
        ...
        <View style={styles.buttonWrap}>
          <Button
            ...
            onPress={() =>
              run('navigateTo', () =>
                Miniapp.navigateTo(`/page3?from=page2&ts=${Date.now()}`),
              )
            }
            color="#ec4899"
          />
        ...
        <View style={styles.buttonWrap}>
          <Button
            ...
            onPress={() =>
              run('redirectTo', () =>
                Miniapp.redirectTo(`/page3?replaced=true`),
              )
            }
            color="#f59e0b"
          />
        ...
        <View style={styles.buttonWrap}>
          <Button
            ...
            onPress={() =>
              run('navigateBack(2)', () => Miniapp.navigateBack(2))
            }
            color="#059669"
          />
        </View>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.buttonWrap}>
          <Button
            title="showToast"
            onPress={() =>
              run('showToast', () => Miniapp.showToast('Page 2 reporting!'))
            }
            color="#06b6d4"
          />
        </View>
