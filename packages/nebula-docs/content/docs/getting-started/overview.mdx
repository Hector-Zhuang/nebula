...
- [Welcome to mini apps](https://web.dev/articles/mini-apps/mini-app-about) — how mini apps are built, discovered, and run
- [What are super apps?](https://web.dev/articles/mini-apps/mini-app-super-apps) — super apps as hosts for mini apps
